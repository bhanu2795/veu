import R from 'ramda';
import { NavigationActions, StackActions as Actions } from 'react-navigation';

export const getResetAction = (screens, key) => Actions.reset({
  index: screens.length - 1,
  actions: R.map(NavigationActions.navigate, screens),
  key,
});
